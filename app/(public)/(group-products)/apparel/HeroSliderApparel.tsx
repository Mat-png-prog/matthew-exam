//app/(public)/(group-products)/apparel/HeroSliderApparel.tsx
...
import type { ApparelSlide } from "../types";
import AddApparelSlideModal from "./AddApparelSlideModal";
import EditApparelSlideModal from "./EditApparelSlideModal";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
/**
 * ApparelHeroSlider Component Props
 */
interface ApparelHeroSliderProps {
  autoPlay?: boolean;
  interval?: number;
  onSlidesChange?: () => void;
  userRole?: UserRole;
  initialSlides: ApparelSlide[];
}

const ApparelHeroSlider: React.FC<ApparelHeroSliderProps> = ({
  autoPlay = true,
  ...
  const { slides, isLoading, deleteSlide, setSlides } = useApparelSlideStore();
...
export default ApparelHeroSlider;