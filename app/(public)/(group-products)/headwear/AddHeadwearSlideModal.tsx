...
// Props for AddHeadwearSlideModal component
interface AddHeadwearSlideModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  targetIndex: number;
...
// AddHeadwearSlideModal component for adding a new slide
const AddHeadwearSlideModal: React.FC<AddHeadwearSlideModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  targetIndex,
  ...
  const { createSlide, slides } = useHeadwearSlideStore();
  ...
  async function onSubmit(data: CreateSlideInput) {
    try {
      ...
      console.log("[AddHeadwearSlideModal] Submitting new slide data (not exposing sensitive info)", { title: data.title, order: data.order });
      ...
      if (typeof window === "undefined") {
        ...
        console.error("[AddHeadwearSlideModal] Add error:", error);
      }
      toast.error(
...
export default AddHeadwearSlideModal;
