//app/(public)/(group-products)/apparel/EditHeadwearSlideModal.tsx
...
import useHeadwearSlideStore from "./_store/headwear-slide";
import Image from "next/image";
import { HeadwearSlide } from "../types";

// Props for the EditHeadwearSlideModal component
interface EditHeadwearSlideModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  slide: HeadwearSlide;
...
// EditHeadwearSlideModal component for editing an existing slide
const EditHeadwearSlideModal: React.FC<EditHeadwearSlideModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  slide,
  ...
  const { updateSlide, slides } = useHeadwearSlideStore();
  ...
  async function onSubmit(data: EditSlideFormValues) {
    try {
      setLoading(true);
      console.log("[EditHeadwearSlideModal] Submitting updated slide data (not exposing sensitive info)", { title: data.title, order: data.order });
      ...
      if (typeof window === "undefined") {
        ...
        console.error("[EditHeadwearSlideModal] Update error:", error);
      }
      toast.error(
...
export default EditHeadwearSlideModal;