...
/**
 * HeadwearHeroSlider Component Props
 */
interface HeadwearHeroSliderProps {
  autoPlay?: boolean;
  interval?: number;
  onSlidesChange?: () => void;
  userRole?: UserRole;
  initialSlides: HeadwearSlide[];
}

const HeadwearHeroSlider: React.FC<HeadwearHeroSliderProps> = ({
  autoPlay = true,
  ...
  const { slides, isLoading, deleteSlide, setSlides } = useHeadwearSlideStore();
...
export default HeadwearHeroSlider;
