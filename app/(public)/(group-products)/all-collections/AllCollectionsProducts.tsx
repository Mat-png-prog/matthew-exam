//app/(public)/(group-products)/all-collections/AllCollectionsProducts.tsx
...
export default function AllCollectionsProducts() {
  ...
  // For all-collections, we use the full products array
