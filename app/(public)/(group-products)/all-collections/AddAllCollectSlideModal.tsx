//app/(public)/(group-products)/all-collections/AddAllCollectSlideModal.tsx
...
// Props for AddAllCollectionsSlideModal component
interface AddAllCollectionsSlideModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
  targetIndex: number;
...
// AddAllCollectionsSlideModal component for adding a new slide
const AddAllCollectionsSlideModal: React.FC<AddAllCollectionsSlideModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  targetIndex,
  ...
  const { createSlide, slides } = useAllCollectionsSlideStore();
  ...
  async function onSubmit(data: CreateSlideInput) {
    try {
      ...
      console.log("[AddAllCollectionsSlideModal] Submitting new slide data (not exposing sensitive info)", { title: data.title, order: data.order });
      ...
      if (typeof window === "undefined") {
        ...
        console.error("[AddAllCollectionsSlideModal] Add error:", error);
      }
      toast.error(
...
export default AddAllCollectionsSlideModal;